        ...
        <ul class="flex items-center">
            @if ($agent->isMobile())
                ...
                <div id="drawer-navigation"
                    ...
                    <h5 id="drawer-navigation-label" class="flex gap-3 text-base font-semibold text-gray-500 uppercase"> <svg
                            ...
                            @auth
                                <li>
                                    <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg">
                                        ...
                                        <span class="flex-1 ms-3 whitespace-nowrap">Lista de itens</span>
                                ...
                                @if (auth()->user()->is_gerente)
                                    <li>
                                        <a href="/funcionarios"
                                            class="flex items-center p-2 text-gray-900 rounded-lghover:bg-gray-100">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                                class="size-6">
                                                <path
                            ...
                            @guest
                                <li>
                                    <a href="/login"
                                        ...
                                        <span class="ms-3">Fazer Login</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/cadastro"
                                        ...
                                        <span class="ms-3">Fazer cadastro</span>
                                    </a>
                                </li>
