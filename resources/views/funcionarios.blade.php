                ...
                <table class="w-full divide-y divide-gray-200 shadow-sm rounded-lg overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($users as $user)
                            <tr>
                                <td class="px-6 py-4 text-center whitespace-nowrap">{{ substr($user->name, 0, 15) }}</td>
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            @else
                                                ...
                                                <form action="/funcionarios/edit{{ $user->id }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" id="is_gerente" name="is_gerente"
                                                        value="{{ true }}">
                                                    <button data-modal-hide="popup-edit-modal-{{ $user->id }}"
                                                        type="submit"
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            @if ($user->is_gerente)
                                                <h3 class="mb-5 text-lg font-normal text-gray-500">Não é possivel remover
                                                    um
                                                    usuário gerente!</h3>
